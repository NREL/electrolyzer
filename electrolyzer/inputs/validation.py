...
# fschema_geom = os.path.join(
#     os.path.dirname(os.path.realpath(__file__)), "geometry_schema.yaml"
# )
fschema_model = os.path.join(
    os.path.dirname(os.path.realpath(__file__)), "modeling_schema.yaml"
)
# fschema_opt = os.path.join(
#     os.path.dirname(os.path.realpath(__file__)), "analysis_schema.yaml"
# )
            ...
            for k in e.validator_value:
                if k not in e.instance.keys():
                    ...
                    if (
                        ...
                        or v in ["name", "material"]
                    ):
                        # Too complicated to just copy over default, so give it back
                        raise (e)
                    else:
                        print(
...
# ---------------------
# See: https://python-jsonschema.readthedocs.io/en/stable/faq/#why-doesn-t-my-schema-s-default-property-set-the-default-on-my-instance # noqa
